...
func main() {
	fmt.Println("🚀 Superintelligence Dependency Manager - AI Provider Runtime Validation")
	fmt.Println("=========================================================")
	...
	providers := superint.GetAvailableProviders()
...
func testVersionDiffAnalysis() {
	...
	response, err := superint.AnalyzeVersionDiff(ctx, request)
	if err != nil {
...
func testCompatibilityPrediction() {
	...
	response, err := superint.PredictCompatibility(ctx, request)
	if err != nil {
...
func testUpdateClassification() {
	...
	response, err := superint.ClassifyUpdate(ctx, request)
	if err != nil {
