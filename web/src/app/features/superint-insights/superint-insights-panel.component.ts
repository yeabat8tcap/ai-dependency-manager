...
@Component({
  selector: 'app-superint-insights-panel',
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
  ...
  template: `
    <div class="superint-insights-container">
      ...
      <mat-card class="no-insights-card" *ngIf="insights.length === 0 && !loading">
        <mat-card-content>
          <div class="no-insights">
            ...
            <h3>No Superintelligence Insights Available</h3>
            <p>Run a dependency scan to generate Superintelligence-powered insights and recommendations.</p>
