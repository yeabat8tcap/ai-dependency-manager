...
// PullRequest is now defined in shared_types.go
// PullRequestBranch is now defined in shared_types.go
...
func GeneratePatchPRBody(config *PatchPullRequestConfig) string {
	...
	body.WriteString("This pull request was automatically generated by the Superintelligence Dependency Manager to update a dependency with potential breaking changes.\n\n")
	...
	// Footer
	body.WriteString("---\n")
	body.WriteString("*This pull request was created automatically by [Superintelligence Dependency Manager](https://github.com/8tcapital/superint-dep-manager). ")
...
// ListPatchPRs lists all patch pull requests created by the Superintelligence Dependency Manager
func (p *PullRequestsService) ListPatchPRs(ctx context.Context, owner, repo string) ([]*PullRequest, error) {
	...
	for _, pr := range prs {
		// Check if PR was created by Superintelligence Dependency Manager
		if strings.Contains(pr.Title, "🤖") ||
			...
			(pr.Body != "" && strings.Contains(pr.Body, "Superintelligence Dependency Manager")) {
...
// ListForBranch lists pull requests for a specific branch
func (p *PullRequestsService) ListForBranch(ctx context.Context, owner, repo, branch string) ([]*PullRequest, error) {
	return p.List(ctx, owner, repo, &PullRequestListOptions{
